...
<div class="container mt-3 ">
    <div class="row justify-content-center d-flex mt-5">
        <div class="col-md-12">
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    <img src={{asset('uploads/'.$book->image)}} alt="" class="card-img-top">
                </div>
                        ...
                        @if ($relatedBooks->isNotEmpty())
                          ...
                          <div class="col-md-4 col-lg-4 mb-4">
                            <div class="card border-0 shadow-lg">
                                <img src="{{asset('uploads/'.$relatedBook->image)}}" alt="" class="card-img-top">
                                <div class="card-body">
                                    <h3 class="h4 heading">{{$relatedBook->name}}</h3>
